...
return (
  <div>
    <div className="mb-2">
      <h5>Graph ID</h5>
      <p><i>Default graph is "follow". 
        Use "*/graph/*" in the Explore Data section below to find more. 
        Other options include: follow, like, star, etc.</i>
      </p>
    ...
    {state.accounts.length > 1 ? (
      <div className="mb-2">
        <Widget
          src="${config_account}/widget/explore.socialgraph"
          props={{
